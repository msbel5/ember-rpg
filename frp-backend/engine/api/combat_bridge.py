...
from engine.api.campaign.called_shot import _normalize_called_shot, _validate_called_shot
from engine.api.campaign.combat_payload import (
    _DIRECTION_DELTAS,
    ...
    _passable_tile,
    build_combat_payload as _build_combat_payload,
)
...
def build_combat_payload(context: "CampaignContext") -> Optional[dict[str, Any]]:
    return _build_combat_payload(context, _combat_state(context))
