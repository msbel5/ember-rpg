...
def _creation_response(context) -> CampaignCreationStateResponse:
    ...
    return CampaignCreationStateResponse(
        ...
        facet_scores=payload["facet_scores"],
        adapter_bias=payload["adapter_bias"],
        faction_bias=payload["faction_bias"],
        settlement_bias=payload["settlement_bias"],
        campaign_genesis=payload["campaign_genesis"],
        world_seed_hints=payload["world_seed_hints"],
...
def finalize_campaign_creation(creation_id: str, req: CampaignCreationFinalizeRequest):
    try:
        context = campaign_runtime.finalize_creation(
            ...
            selected_facets=req.selected_facets,
