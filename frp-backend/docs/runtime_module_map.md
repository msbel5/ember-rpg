...
| `frp-backend/engine/api/campaign/live_kernel.py` | 421 | - | ensure_kernel_runtime, serialize_kernel_runtime, advance_kernel_runtime, _check_level_up |
| `frp-backend/engine/api/campaign/party_bridge.py` | 183 | - | maybe_handle_party_command, party_member_ids, party_summary, allied_actor_ids |
| `frp-backend/engine/api/campaign/persistence.py` | 198 | - | campaign_payload, persist_campaign_state, build_kernel_payload, _active_site_id |
...
| `frp-backend/engine/api/campaign/region_projection.py` | 413 | - | _preserved_party_entities, _restore_party_entities, apply_region_to_context, build_map_data |
...
| `frp-backend/engine/kernel/game_state.py` | 298 | JournalEntry (2), WorldTime (3), DifficultySettings (3), GameState (2) | _normalized_party_ids, create_game_state, add_to_party, remove_from_party |
